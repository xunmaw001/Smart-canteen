<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="分量" prop="fenliang">
          <el-select :disabled="ro.fenliang" v-model="ruleForm.fenliang" placeholder="请选择分量">
            <el-option
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.fenliangOptions = "标准,中份,大份".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
